	...
	return (
		...
		>
			...
			<CollapsibleContent className="mt-3">
				{previous ? (
					<div className="px-3 py-6 flex flex-col items-center gap-3 bg-fd-card text-fd-card-foreground text-sm text-center rounded-xl dark:text-fd-muted-foreground">
					...
					<form className="flex flex-col gap-3" onSubmit={submit}>
						...
						/>
						<button type="submit" className={cn(buttonVariants({ color: "outline" }), "w-fit px-3")}>
							Submit
						</button>
					</form>
				)}
